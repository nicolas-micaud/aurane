...
5. **Mémoire**. À la fin de chaque saison, le Général rédige des **mémoires** de trois paragraphes, stockées avec le compte. Il en cite des extraits la saison suivante. Le joueur les relit, les partage. Cette mémoire porte un nom public, **Corthexis** (Nick, 26.09.2026) : c'est le mot qu'on emploie sur la landing et dans le jeu pour « ce que ton Général sait de toi », et elle appartient au joueur, qui la lit, l'exporte et l'efface. Le briefing de retour en fait la preuve à chaque fois : il **nomme la dernière décision du joueur** (« tu avais écarté “relier Irzen” ; je n'y suis pas revenu, et j'ai relié deux étoiles entre-temps ») et le nom qu'il n'oublie pas (une trahison, un attaquant récidiviste). Et le Général a une volonté : une doctrine qui coulerait la Colonie (tout vendre, se passer d'Énergie, abandonner la capitale, frapper un partenaire de traité) est **refusée en personnage, avec la raison et ce qu'il accepterait à la place**, avant tout appel au modèle.

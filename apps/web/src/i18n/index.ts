...
const STRINGS = {
  fr: {
    ...
    extractorDesc: 'Rendement du système +50 %.', refineryDesc: '6 Rium par Tirage. Seulement en orbite d\'une géante gazeuse.', synthesizerDesc: '8 Énergie + 4 Vivres → 4 Rium par Tirage.', shipyardDesc: 'Permet d\'entraîner des vaisseaux ici.', bastionDesc: 'Défense ×2, protège les relais voisins.', tradepostDesc: 'Une région de marché en plus, frais réduits.', amplifierDesc: 'Portée des relais partant d\'ici +25 %.', antennaDesc: 'Révèle les secteurs voisins.', warehouse: 'Entrepôt', warehouseDesc: 'Stock local +900 par ressource.', turret_light: 'Tourelle légère', turret_lightDesc: 'Tir rapide. Déchire les corvettes.', turret_heavy: 'Tourelle lourde', turret_heavyDesc: 'Gros calibre. Casse les croiseurs.', launcher: 'Lance-missiles', launcherDesc: 'Longue portée. Chasse les frégates.', cargo: 'Cargo', cargoDesc: 'Transporte 120 ressources. Sans armes : escorte-le.', relayDesc: 'Second relais sur un autre astre : le Réseau tient si la station tombe.', station: 'Station', underAttack: 'sous le feu', localStock: 'Entrepôt local',

...
const STRINGS = {
  fr: {
    ...
    coach6: 'Dans un système, touche une installation ou une flotte pour la sélectionner ; touche un emplacement libre pour construire.',
  ...
  en: {
    ...
    coach6: 'Inside a system, tap a structure or a fleet to select it; tap a free slot to build.',

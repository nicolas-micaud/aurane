...
const STRINGS = {
  fr: {
    ...
    recenter: 'Recentrer (double-clic)', salvage: 'Épave à fouiller', salvageHere: 'Fouiller l\'épave', laneTravel: 'en transit vers', mainBody: 'corps principal', bodies: 'corps', sendHere: 'Envoyer ici', relayHere: 'Relais de secours ici',
  ...
  en: {
    ...
    recenter: 'Recentre (double-click)', salvage: 'Salvage left', salvageHere: 'Salvage the wreck', laneTravel: 'in transit to', mainBody: 'main body', bodies: 'bodies', sendHere: 'Send here', relayHere: 'Backup relay here',

...
const STRINGS = {
  fr: {
    ...
    extractorDesc: 'Rendement du système +50 %.', shipyardDesc: 'Permet d\'entraîner des vaisseaux ici.', bastionDesc: 'Défense ×2, protège les relais voisins.', tradepostDesc: 'Une région de marché en plus, frais réduits.', amplifierDesc: 'Portée des relais partant d\'ici +25 %.', antennaDesc: 'Révèle les secteurs voisins.',
  ...
  en: {
    ...
    extractorDesc: 'System yield +50%.', shipyardDesc: 'Lets you train ships here.', bastionDesc: 'Defence ×2, protects adjacent relays.', tradepostDesc: 'One more market region, lower fees.', amplifierDesc: 'Relay range from here +25%.', antennaDesc: 'Reveals neighbouring sectors.',

...
import { act, addPasskey, answerCounsel, eraseMemory, exportMemory, fetchAccount, fetchBriefing, fetchCounsel, fetchEntitlements, fetchPublicConfig, fetchSessions, fetchTalk, logout, paidReturn, startCheckout, type PaymentsConfig, passkeysSupported, removeEmail, removePasskey, revokeSession, startEmail, status, talk as sendTalk, toast, verifyEmail, view, requestLink, type AccountInfo, type CounselCard, type CounselView, type SessionInfo, type Turn } from '../net.js';

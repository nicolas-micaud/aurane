...
export class GeneralService {
  ...
  /** Restore the month's spend so the cap survives a restart; move memories still keyed by a bare colony id. */
  ...
  async stop(): Promise<void> { await this.scheduler.stop(); await this.mirror?.stop(); }
